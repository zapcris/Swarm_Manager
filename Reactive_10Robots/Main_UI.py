...
def opcua_server():
    #os.system('C:\Users\aksha\PycharmProjects\Swarm_Manager_VisualComponents\Reactive_10Robots.SM01_opcua_server.py')
    os.system("python SM01_opcua_server.py")
...
b5 = tk.Button(window, text='Run Simulation', command=opcua_server).grid(column=25,
