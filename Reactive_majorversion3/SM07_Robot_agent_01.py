...
from Reactive_majorversion3.SM10_Product_Task import Product, Task, Transfer_time, Waiting_time, Sink, Process_time

#### Data Initialization ################
# production_order = {}
# production_order["Name"] = "Test"
# production_order["Process_times"] = [[10, 10, 20, 10, 15, 14, 15, 12, 10, 10],  # [20, 30, 40, 50, 20, 40, 80, 70, 30, 60]
...
# doc = mycol.find_one()
# production_order["prod_name"] = doc["Product_name"]
# production_order["PI"] = doc["Product_volume"]
# production_order["sequence"] = doc["Production_Sequence"]
