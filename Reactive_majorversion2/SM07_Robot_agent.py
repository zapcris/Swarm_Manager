...
class Transfer_robot:
    ...
    async def execution_timer(self, event_main: asyncio.Event, event_init_task: asyncio.Event, loop: asyncio.AbstractEventLoop):
        while True:
            ...
            match self.task_step:
                case 2:
                    ...
                    print(f"Robot{self.id} picked up the product")
